...
[read slides]
martin duke: new initial is supposed to have same dcid. so in general case this will 
be routed to same server and we wont have this problem
...
SKIPPING VARINTS FOR TPARAMS from agenda [mnot]
...
3 min - Agenda bashing
Spin Bit
15 min - Overview - Marcus Ihlar (slides)
...
Richard Barnes: Seems odd to have "acceptable" in the hum confirmation. [ACCEPTABLE IS REMOVED]
...
Charter/Milestones:
    Has us shipping QUIC RFCs in November. That seems unlikely ;)
